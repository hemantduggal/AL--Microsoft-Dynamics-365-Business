/// <summary>
/// Report Customer - Summary Aging (ID 50128).
/// </summary>
report 50128 "Customer - Summary"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'SalesReceivables/CustomerSummaryAging.rdl';
    ...
    var
        ...
        Customer_Summary_AgingCaptionLbl: Label 'Customer - Ledger';
    ...
    /// <summary>
    /// OnBeforeFillColumnsInteger.
    /// </summary>
    /// <param name="Customer">VAR Record Customer.</param>
    /// <param name="DtldCustLedgEntry">VAR Record "Detailed Cust. Ledg. Entry".</param>
