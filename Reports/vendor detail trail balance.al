/// <summary>
/// Report Vendor - Detail Trial Balance (ID 50105).
/// </summary>
report 50106 "Vendor  Detail Trial Balance"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'ReportLayout\VendorDetailTrialBalance.rdl';
    ...
    begin
        ...
        if PrintAmountsInLCY then begin
            AmountCaption := "Vendor Ledger Entry".FieldCaption("Vendor Ledger Entry"."Amount (LCY)");
            RemainingAmtCaption := "Vendor Ledger Entry".FieldCaption("Vendor Ledger Entry"."Remaining Amt. (LCY)");
        end else begin
            AmountCaption := "Vendor Ledger Entry".FieldCaption("Vendor Ledger Entry".Amount);
            RemainingAmtCaption := "Vendor Ledger Entry".FieldCaption("Vendor Ledger Entry"."Remaining Amount");
        end;
    end;
